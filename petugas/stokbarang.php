                    ...
                    <div class="table-responsive">
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><a type='button' href="?page=editbarang&id_produk=<?php echo $data['id_produk']?>" 
                                       class="btn btn-sm btn-primary btn-icon-split btn-sm">
                                        <span class="icon text-white-50"><i class="fas fa-edit"></i></span>
                                        <span class="text">Edit</span>
                                    </a>
                                    <a onclick="return confirm('Apakah anda yakin ingin menghapusnya')"' href="?page=hapusbarang&id_produk=<?php echo $data['id_produk']?>" 
